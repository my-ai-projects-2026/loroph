...
const Footer = () => {
  ...
  return (
    <footer
      id="main-footer"
      className="w-full px-8 py-12 flex flex-col items-center gap-6 text-center bg-slate-950/40 border-t border-slate-800/60 backdrop-blur-md mt-12 mb-20 md:mb-0 relative z-10"
    >
      <div className="flex items-center gap-3 mb-2">
        <Logo />
      </div>
      <div className="hidden md:flex flex-wrap justify-center gap-8 text-slate-400 text-xs font-mono">
        <Button
      ...
      <p className="text-slate-500 text-xs font-mono opacity-80 mt-2">
