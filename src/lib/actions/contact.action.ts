...
export async function submitContactForm(
  ...
  try {
    ...
    const smtpUser =
      process.env.SMTP_USER || (process.env.RESEND_API_KEY ? "resend" : "");
    const smtpPassword =
    ...
    if (!smtpHost || !smtpUser || !smtpPassword) {
      ...
      console.log("==========================================");
      console.log(
        "ℹ️ Configure SMTP_HOST, SMTP_USER, and SMTP_PASSWORD to send real emails.",
      );
      console.log("==========================================\n");
    ...
    const fromEmail =
      process.env.CONTACT_EMAIL_FROM || `L.O.R.O Contact Form <${smtpUser}>`;
